...
yum install gcc c++ zip unzip man vim  bind-utils telnet wget nethogs htop glances dstat traceroute lrzsz goaccess ntpdate dos2unix openssl-devel xinetd lvm2 lftp nfs-utils net-tools
...
#binlog查看
mysqlbinlog -v --base64-output=decode-rows --start-datetime='2019-03-27 17:30:00' --stop-datetime='2019-03-27 17:40:00' mysql-bin.000089 > /tmp/DB111.sql
...
alter table table_name auto_increment= 1; #重置自增ID
