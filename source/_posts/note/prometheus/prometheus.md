...
`服务发现`是prometheus最强大的功能之一，这个功能配合[relabel_config](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#)、[*_exporter](https://prometheus.io/docs/instrumenting/exporters/)可以做成很多事情。
